...
export default function EspaceClientPage() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full overflow-hidden bg-white text-[15px]">
      <aside
        aria-hidden
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[520px] flex-1 flex-col justify-start pt-10 sm:pt-12 lg:pt-6">
          ...
          >
            <div className="relative mx-auto inline-block">
              <div className="pointer-events-none absolute -inset-8 z-[-1] opacity-70">
                <Particles color="30,47,138" opacity={0.5} count={20} speed={0.25} maxDist={45} />
              </div>
              <Image
                src="/logo-groupe.png"
                alt="Groupe SICA"
                ...
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-xl border border-[#E4E7F0] bg-[#F7F8FC] py-4 pl-12 pr-4 text-base text-[#08112E] outline-none transition-all duration-200 placeholder:text-[#9AA3BE] focus:border-[#1E2F8A] focus:bg-white focus:shadow-[0_0_0_3px_rgba(30,47,138,0.09)]"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-xl border border-[#E4E7F0] bg-[#F7F8FC] py-4 pl-12 pr-12 text-base text-[#08112E] outline-none transition-all duration-200 placeholder:text-[#9AA3BE] focus:border-[#1E2F8A] focus:bg-white focus:shadow-[0_0_0_3px_rgba(30,47,138,0.09)]"
                    />
                    <button
                      type="button"
