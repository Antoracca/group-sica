        ...
        <div className="grid gap-16 lg:grid-cols-[1fr_1fr] lg:items-center">
          ...
          <div>
            <p className="font-mono text-xs font-bold uppercase tracking-widest text-brand-royal">
              Innovation Groupe SICA
            </p>
            <h2
              id="groupe-devis-ia-title"
              className="mt-6 font-display text-4xl font-bold leading-[1.05] tracking-tight text-ink md:text-5xl"
            >
              Le devis structuré, <br className="hidden lg:inline" />
              généré à partir d&apos;un <span className="relative inline-block">
            ...
            <p className="mt-6 max-w-[54ch] text-lg leading-relaxed text-slate">
              Premier service du Groupe SICA exploitant l'analyse structurelle pour accélérer le pré-cadrage de vos projets. Importez vos plans architecturaux et obtenez instantanément un Devis Quantitatif Estimatif (DQE) structuré en 11 lots selon notre base de prix officielle.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <span className="font-mono text-[0.7rem] uppercase tracking-[0.14em] text-slate font-bold">
                Disponible sur SICA Construction
              </span>
            </div>
          </div>
